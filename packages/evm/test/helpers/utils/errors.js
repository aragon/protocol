const ARAGON_PROTOCOL_ERRORS = {
  SENDER_NOT_DISPUTE_SUBJECT: 'AP_SENDER_NOT_DISPUTE_SUBJECT'
}
...
const DISPUTE_MANAGER_ERRORS = {
  ...
  WONT_REWARD_NON_VOTER_GUARDIAN: 'DM_WONT_REWARD_NON_VOTER_GUARDIAN',
  WONT_REWARD_INCOHERENT_GUARDIAN: 'DM_WONT_REWARD_INCOHERENT_GUARDIAN',
...
const VOTING_ERRORS = {
  ...
  SENDER_NOT_REPRESENTATIVE: 'CRV_SENDER_NOT_REPRESENTATIVE',
...
const REGISTRY_ERRORS = {
  ...
  INVALID_REWARDED_GUARDIANS_LENGTH: 'GR_INVALID_REWARDED_GUARDIANS_LEN',
...
const PAYMENTS_BOOK_ERRORS = {
  ...
  PERIOD_BALANCE_DETAILS_NOT_COMPUTED: 'PB_PERIOD_BALANCE_DETAILS_NOT_COMPUTED',
  PAYMENT_AMOUNT_ZERO: 'PB_PAYMENT_AMOUNT_ZERO',
  ETH_DEPOSIT_MISMATCH: 'PB_ETH_DEPOSIT_MISMATCH',
  ...
  GUARDIAN_CANNOT_CLAIM_SHARE: 'PB_GUARDIAN_CANNOT_CLAIM_SHARE',
  GOVERNOR_CANNOT_CLAIM_SHARE: 'PB_GOVERNOR_CANNOT_CLAIM_SHARE',
...
const CONFIG_ERRORS = {
  ...
  BAD_INITIAL_GUARDIANS_NUMBER: 'CONF_BAD_INITIAL_GUARDIANS_NUMBER',
...
const CLOCK_ERRORS = {
  ...
  CANNOT_DELAY_STARTED_PROTOCOL: 'CLK_CANNOT_DELAY_STARTED_PROTOCOL',
...
const SIGNATURES_VALIDATOR_ERRORS = {
  INVALID_SIGNATURE: 'SV_INVALID_SIGNATURE'
}

module.exports = {
  ARAGON_PROTOCOL_ERRORS,
