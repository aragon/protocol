...
const REGISTRY_EVENTS = {
  ...
  GUARDIAN_ACTIVATION_LOCK_INCREASED: 'GuardianActivationLockIncreased',
  GUARDIAN_ACTIVATION_LOCK_DECREASED: 'GuardianActivationLockDecreased',
  LOCK_MANAGER_CHANGED: 'LockManagerChanged',
