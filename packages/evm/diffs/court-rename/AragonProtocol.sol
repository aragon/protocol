...
// Brought from https://github.com/aragon/aragonOS/blob/v4.3.0/contracts/lib/token/IERC20.sol
// Adapted to use pragma ^0.5.8 and satisfy our linter rules
...
// File: contracts/core/controller/Controller.sol
...
contract Controller is IsContract, ProtocolClock, ProtocolConfig {
    ...
    bytes32 internal constant guardianS_REGISTRY = 0x3b21d36b36308c830e6c4053fb40a3b6d79dde78947fbf6b0accd30720ab5370;
    ...
    */
    ...
    /**
    * @dev Tell the address of the GuardiansRegistry module
    * @return Address of the GuardiansRegistry module
    */
    function getGuardiansRegistry() external view returns (address) {
...
// File: contracts/AragonProtocol.sol
