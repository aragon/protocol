...
contract DisputeManager is ControlledRecoverable, ICRVotingOwner, IDisputeManager {
    ...
    */
    function _createRound(uint256 _disputeId, DisputeState _disputeState, uint64 _draftTermId, uint64 _guardiansNumber, uint256 _guardianFees) internal
        returns (uint256)
    {
    ...
    */
    function _computeGuardianWeight(Dispute storage _dispute, uint256 _roundId, address _guardian, Config memory _config) internal returns (uint64) {
    ...
    */
    function _getNextRegularRoundGuardiansNumber(AdjudicationRound storage _round, DisputesConfig memory _config) internal view returns (uint64) {
